...
const CitizenLayout = () => {
  ...
  const menuItems = [
    { path: "/citizen/services", label: "Services", icon: "🛠️" },
    { path: "/citizen/requests", label: "My Requests", icon: "📋" },
    { path: "/citizen/payments", label: "My Payments", icon: "💳" },
    { path: "/citizen/notifications", label: "Notifications", icon: "🔔" },
        ...
        <div className="p-6 border-b border-gray-100">
          <Link to="/" className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-gray-500 text-xs">Citizen Panel</p>
            </div>
          </Link>
        </div>
        ...
        <div className="p-4 border-t border-gray-100">
          <div className="flex items-center space-x-3 mb-3 p-2">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-gray-500 text-xs">Citizen User</p>
            </div>
          </div>
          ...
          <div className="flex justify-between items-center px-6 py-4">
            <div>
              <h1 className="text-xl font-semibold text-gray-800">
                {menuItems.find(item => isActiveLink(item.path))?.label || "Citizen Dashboard"}
              </h1>
            ...
            <div className="flex items-center space-x-4 bg-blue-50 px-4 py-2 rounded-lg border border-blue-100">
              <div className="flex items-center space-x-3">
                ...
                <div className="text-left">
                  <p className="text-sm font-medium text-blue-800">{user?.name || 'Citizen'}</p>
                  <p className="text-xs text-blue-600">Citizen</p>
                </div>
              </div>
