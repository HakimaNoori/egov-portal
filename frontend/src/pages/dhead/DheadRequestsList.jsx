  ...
  return (
    <div className="p-6">
      <section className="bg-white p-6 rounded-2xl shadow-sm">
        <h2 className="text-xl font-semibold">Department Requests (Dhead)</h2>
      </section>
              ...
              <tbody>
                {requests.map((r) => (
                  <tr key={r.id} className="border-b hover:bg-gray-50">
                    ...
                    <td className="px-3 py-2"><Link to={`/dhead/requests/${r.id}`} className="px-3 py-1 border rounded-lg hover:bg-gray-100">View</Link></td>
                  </tr>
                ))}
