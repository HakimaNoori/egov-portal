...
export default function DHeadNotifications() {
    ...
    <div className="p-6 space-y-6">
      ...
      <section className="bg-white p-6 rounded-2xl shadow-sm border border-gray-200">
        <div className="flex justify-between items-center mb-4">
          <div>
            <h2 className="text-xl font-semibold text-gray-800">Department Notifications</h2>
            <p className="text-gray-600 text-sm mt-1">
              Updates on department activities and system notifications
            </p>
          </div>
          {unreadCount > 0 && (
            <button
