...
export default function OfficerRequestDetails() {
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex gap-2">
        <button onClick={handleMarkReviewed} disabled={updating || request.status === "reviewed" || reviewed} className="px-4 py-2 bg-blue-600 text-white rounded-lg">
          {updating ? "Saving..." : request.status === "reviewed" || reviewed ? "Reviewed" : "Mark Reviewed"}
        </button>
      </div>
